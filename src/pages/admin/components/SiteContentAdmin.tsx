...
const DEFAULT_KEYS: Array<{ key: string; label: string; type: "text" | "textarea" }> = [
  ...
  { key: "hero_title", label: "Título (Hero)", type: "textarea" },
  { key: "hero_subtitle", label: "Subtítulo (Hero)", type: "text" },
  { key: "hero_cta", label: "Texto do Botão (Hero)", type: "text" },
  { key: "about_title", label: "Título (Seção Sobre)", type: "textarea" },
  { key: "about_description", label: "Texto (Seção Sobre)", type: "textarea" },
  { key: "therapists_label", label: "Etiqueta (Seção Terapeutas)", type: "text" },
  { key: "therapists_title", label: "Título (Seção Terapeutas)", type: "textarea" },
  { key: "therapists_description", label: "Texto (Seção Terapeutas)", type: "textarea" },
  { key: "events_label", label: "Etiqueta (Seção Eventos)", type: "text" },
  { key: "events_title", label: "Título (Seção Eventos)", type: "textarea" },
  { key: "events_description", label: "Texto (Seção Eventos)", type: "textarea" },
  { key: "faq_title", label: "Título (Seção FAQ)", type: "text" },
  { key: "faq_description", label: "Texto (Seção FAQ)", type: "textarea" },
  { key: "contact_title", label: "Título (Seção Contato)", type: "textarea" },
  { key: "contact_description", label: "Texto (Seção Contato)", type: "textarea" },
  { key: "support_text", label: "Texto de apoio (Geral)", type: "textarea" },
